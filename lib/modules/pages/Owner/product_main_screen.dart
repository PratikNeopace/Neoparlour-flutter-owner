...
import 'package:neo_parlour_owner/modules/pages/Owner/add_product_screen.dart';
        ...
        body: Column(
          children: [
            ...
            const Expanded(
              child: TabBarView(
                children: [
                   AddProductScreen(showAsTab: true, initialTabIndex: 0),
                   AddProductScreen(showAsTab: true, initialTabIndex: 1),
                ],
              ),
            ),
          ],
